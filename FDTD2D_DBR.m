...
%% THIN-FILMS - DISTRIBUTION BRAGG REFLECTION
...
er2 = er2_inf;
ur2 = ur2_inf;
layer1 = 950/4/sqrt(er1) * nm;
layer2 = 950/4/sqrt(er2) * nm;
N = 10; 
...
for i=1:n_res
    ...
    GammaE(i,:,ny1:ny2) = Gamma_E1(i);
    W0E(i,:,ny1:ny2) = W0_E1(i);
    fE(i,:,ny1:ny2) = f_E1(i);

    GammaM(i,:,ny1:ny2) = Gamma_M1(i);
    W0M(i,:,ny1:ny2) = W0_M1(i);
    fM(i,:,ny1:ny2) = f_M1(i);

end

% ADD LAYER2
ERxx(1,:,ny2+1:ny3) = er2;
ERyy(1,:,ny2+1:ny3) = er2;
ERzz(1,:,ny2+1:ny3) = er2;

WpE(1,:,ny2+1:ny3) = Wp_E2;

URxx(1,:,ny2+1:ny3) = ur2;
URyy(1,:,ny2+1:ny3) = ur2;
URzz(1,:,ny2+1:ny3) = ur2;

WpM(1,:,ny2+1:ny3) = Wp_M2;

for i=1:n_res
    
    GammaE(i,:,ny2+1:ny3) = Gamma_E2(i);
    W0E(i,:,ny2+1:ny3) = W0_E2(i);
    fE(i,:,ny2+1:ny3) = f_E2(i);

    GammaM(i,:,ny2+1:ny3) = Gamma_M2(i);
    W0M(i,:,ny2+1:ny3) = W0_M2(i);
    fM(i,:,ny2+1:ny3) = f_M2(i);
...
% ADD SUBSTRATE
ERxx(1,:,ny3+1:Ny) = er_sub;
ERyy(1,:,ny3+1:Ny) = er_sub;
ERzz(1,:,ny3+1:Ny) = er_sub;

URxx(1,:,ny3+1:Ny) = ur_sub;
URyy(1,:,ny3+1:Ny) = ur_sub;
URzz(1,:,ny3+1:Ny) = ur_sub;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
