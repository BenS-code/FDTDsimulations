...
fmax = 0.35 * PHz;                    % maximum frequency
NFREQ = 100;                         % number of frequencies
FREQ = linspace(fmin,fmax,NFREQ);    % frequency array
        
% MATERIAL PROPERTIES
Wp_E1 = 13.72e15;
Gamma_E1 = [0.08052 0.3661 0.5241].*1e15;
W0_E1 = [0 0.6305 1.261].*1e15;
f_E1 = [0.76 0.024 0.01];
er1_inf = 6.9;
...
Wp_E2 = 13.72e15;
Gamma_E2 = [0.08052 0.3661 0.5241].*1e15;
W0_E2 = [0 0.6305 1.261].*1e15;
f_E2 = [0.76 0.024 0.01];
er2_inf = 6.9;
...
nx1 = 1;
nx2 = nx1 + round(period/dx) - 1;
nx_grating1 = 1;
nx_grating2 = nx_grating1 + round(gx/dx) - 1;
...
% ADD LAYER1 (GRATING)
ERxx(1,nx_grating1:nx_grating2,ny1:ny2) = er1;
ERyy(1,nx_grating1:nx_grating2,ny1:ny2) = er1;
ERzz(1,nx_grating1:nx_grating2,ny1:ny2) = er1;

WpE(1,nx_grating1:nx_grating2,ny1:ny2) = Wp_E1;

URxx(1,nx_grating1:nx_grating2,ny1:ny2) = ur1;
URyy(1,nx_grating1:nx_grating2,ny1:ny2) = ur1;
URzz(1,nx_grating1:nx_grating2,ny1:ny2) = ur1;

WpM(1,nx_grating1:nx_grating2,ny1:ny2) = Wp_M1;

for i=1:n_res
    
    GammaE(i,nx_grating1:nx_grating2,ny1:ny2) = Gamma_E1(i);
    W0E(i,nx_grating1:nx_grating2,ny1:ny2) = W0_E1(i);
    fE(i,nx_grating1:nx_grating2,ny1:ny2) = f_E1(i);

    GammaM(i,nx_grating1:nx_grating2,ny1:ny2) = Gamma_M1(i);
    W0M(i,nx_grating1:nx_grating2,ny1:ny2) = W0_M1(i);
    fM(i,nx_grating1:nx_grating2,ny1:ny2) = f_M1(i);
